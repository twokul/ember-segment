  ...
  contentFor: function(type, config) {
    if (type === 'head' && config.environment !== 'test') {
      ...
      var script = [
        ...
        '"identify","group","track","ready","alias","page","once","off","on"];analytics.factory=function(t)',
        '{return function(){var e=Array.prototype.slice.call(arguments);e.unshift(t);analytics.push(e);',
